...
- Click an added program and select [Launch Application]
- Choose a proxy IP in the pop-up window (from the **IP Pool / 24-Hour List / Port Forwarding**)
